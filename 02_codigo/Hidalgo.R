...
municipios %>% 
  ...
  labs(title = "Casos confirmados de COVID-19 en Hidalgo",
       ...
       caption = "Fuente: Datos Abiertos Secretaria de Salud\nElaboración propia. 13 Abril 2020") +
  scale_x_discrete(labels=c("Pachuca de Soto", "Mineral de la Reforma", "Tulancingo de Bravo", "Tizayuca", "Emiliano Zapata", "San Agustin Tlaxiaca", "Actopan","Atotonilco de Tula", "Chilcuautla", "Epazoyucan", "Francisco I. Madero", "Huasca de Ocampo", "Huejutla de Reyes", "Mineral del Monte", "Santiago de Anaya", "Tepeji del Rio de Ocampo","Tezontepec de Aldama")) +
